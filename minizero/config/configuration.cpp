...
void setConfiguration(ConfigureLoader& cl)
{
    ...
    cl.addParameter("zero_use_jpsro", zero_use_jpsro, "true for training one responder seat against frozen JPSRO joint profiles", "Zero");
    cl.addParameter("zero_jpsro_profile_file", zero_jpsro_profile_file, "TSV oracle profile plan generated by tools/jpsro.py", "Zero");
